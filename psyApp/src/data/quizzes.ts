...
export const QUIZZES: Quiz[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'q2_4', type: 'scenario', scenario: 'Người bán hàng hỏi: "Anh muốn chọn gói dịch vụ 12 tháng hay 24 tháng?" thay vì hỏi bạn có muốn đăng ký hay không.', options: ['Cố gắng hỗ trợ khách hàng tìm kiếm  {
  ...
  }, che đậy những sai lầm trong tính toán cá nhân.' },
      { id: 'q4_8', type: 'scenario', scenario: 'Khi không tìm ra hung thủ, một thám tử báo cáo rằng kẻ phạm tội là một thiên tài với những thủ đoạn quá tinh vi.', options: ['Đánh giá cao kỹ năng của đối thủ để nâng tầm quan trọng của vụ án.', 'Dùng sự xuất sắc của đối phương để biện minh cho sự bế tắc hiện tại.', 'Cảm thấy cần phải tăng cường thêm quân số cho các hoạt động điều tra.', 'Cho rằng manh mối hiện tại chưa đủ để đưa ra bất kỳ kết luận nào.'], correctIndex: 1, explanation: 'Tôn vinh kẻ thù đôi khi chỉ là một cách để xoa dịu thất bại của chính mình.' }
    ]
  },hường là cái kính lọc bóp méo ý nghĩa thực sự của hành động.' },
      { id: 'q3_6', type: 'scenario', scenario: 'Các ứng dụng mạng xã hội liên tục hiển thị những bài viết có cùng quan điểm với những gì bạn thường xuyên chia sẻ.', options: ['Giúp người dùng dễ dàng tìm kiếm những nội dung mà mình yêu thích.', 'Tạo ra một không gian đóng kín chỉ chứa các ý kiến tương đồng.', 'Cỗ máy củng cố thiên lệch thông qua việc lọc dữ liệu cá nhân.', 'Khuyến khích việc kết nối với những người bạn có chung sở thích.'], correctIndex: 1, explanation: 'Thuật toán củng cố những gì bạn đã thích, khiến bạn ngày càng xa rời những luồng tư duy khác.' },
      { id: 'q3_7', type: 'scenario', scenario: 'Trong các cuộc tranh luận, hai bên thường chỉ đưa ra những lý lẽ ủng hộ mình và bác bỏ hoàn toàn dữ liệu từ đối phương.', options: ['Thể hiện sự kiên định và tin tưởng vào chân lý mà mình đang nắm giữ.', 'Không có khả năng xem xét vấn đề từ các góc nhìn khác biệt hơn.', 'Cảm thấy cần phải bảo vệ cái tôi cá nhân trước áp lực của tập thể.', 'Mong muốn đạt được sự đồng thuận nhanh chóng để kết thúc buổi họp.'], correctIndex: 1, explanation: 'Thiên lệch xác nhận khiến cuộc đối thoại trở thành hai màn độc thoại không có điểm chung.' },
      { id: 'q3_8', type: 'scenario', scenario: 'Phương pháp hiệu quả nhất để một thám tử không bị rơi vào cái bẫy của những giả thuyết có sẵn là gì?', options: ['Luôn tin tưởng vào trực giác và những kinh nghiệm phá án trước đây.', 'Chủ động tìm kiếm những bằng chứng có khả năng bác bỏ giả thuyết.', 'Tham khảo ý kiến của số đông để đảm bảo tính khách quan của vụ án.', 'Chờ đợi những chỉ thị chính thức từ phía các cơ quan điều tra cấp cao.'], correctIndex: 1, explanation: 'Chỉ khi dám chứng minh mình sai, thám tử mới có thể tìm thấy sự thật thực sự.' }
    ]
  ...
  {
    id: 'q6',
    title: 'Sự tự tin trong phán đoán cá nhân',
    regionId: 'r1',
    requiredLevel: 6,
    xpReward: 160,
    gemReward: 14,
    questions: [
      { id: 'q6_1', type: 'scenario', scenario: 'Thầy bói phán: “Bạn là người độc lập nhưng đôi khi cũng cô đơn”. Bạn gật gù “chuẩn quá”.', options: ['Thầy đỉnh', 'Barnum effect', 'Duyên số', 'Sự thật'], correctIndex: 1, explanation: 'Lời phán chung chung đến 90% dân số đều thấy đúng.' },
      { id: 'q6_2', type: 'scenario', scenario: 'App cung hoàng đạo bảo “Sư tử hôm nay gặp may”. Bạn nhặt được 5k và tin sái cổ.', options: ['Chiêm tinh đúng', 'Confirmation bias + Barnum', 'Nhặt 5k là may', 'Do Sư tử'], correctIndex: 1, explanation: 'Bạn tự ghép biến cố nhỏ vào lời tiên đoán mơ hồ.' },
      { id: 'q6_3', type: 'scenario', scenario: 'Mô tả tội phạm: “Hắn có mặt tốt mặt xấu”. Bạn gật đầu lia lịa.', options: ['Đúng rồi', 'Bẫy Barnum trong điều tra', 'Hắn hiền', 'Bạn bị lừa'], correctIndex: 1, explanation: 'Mô tả mâu thuẫn nhưng áp dụng được cho tất cả.' },
      { id: 'q6_4', type: 'scenario', scenario: 'Sao các trắc nghiệm tính cách trên mạng toàn khen bạn?', options: ['Vì bạn tốt', 'Barnum effect + nịnh', 'Sự thật', 'Máy tính'], correctIndex: 1, explanation: 'Lời khen chung chung khiến bạn thấy app “chuẩn” và chia sẻ.' },
      { id: 'q6_5', type: 'scenario', scenario: 'Thầy phán: “Có người đang âm thầm giúp con”.', options: ['Cảm động', 'Barnum (ai chả có người giúp)', 'Thầy linh', 'Ảo giác'], correctIndex: 1, explanation: 'Một khẳng định không thể sai, vì ai cũng có ai đó giúp.' },
      { id: 'q6_6', type: 'scenario', scenario: 'Bạn đi xem bói 10 thầy, mỗi thầy phán một kiểu nhưng bạn vẫn tin cả 10.', options: ['Ham học', 'Bẫy Barnum nặng', 'Thầy giỏi hết', 'Tâm linh'], correctIndex: 1, explanation: 'Vô vọng tìm kiếm sự khẳng định từ bên ngoài.' },
      { id: 'q6_7', type: 'scenario', scenario: 'Mô tả nhóm máu A: “Cẩn thận nhưng đôi khi bốc đồng”.', options: ['Nhóm A là thế', 'Barnum effect', 'Đúng quá', 'Do máu'], correctIndex: 1, explanation: 'Lời phán hai mặt luôn đúng với bất kỳ ai.' },
      { id: 'q6_8', type: 'scenario', scenario: 'Thám tử nên làm gì khi nghe lời thầy bói?', options: ['Nghe theo', 'Coi là rác rưởi Barnum', 'Ghi chú', 'Tiết kiệm'], correctIndex: 1, explanation: 'Đừng để lời phán mơ hồ dắt mũi điều tra.' }
    ]
  },
  {
    id: 'q7',
    title: 'Chuyên gia biết thế thì… – Hiệu ứng biết rồi',
    regionId: 'r1',
    requiredLevel: 7,
    xpReward: 180,
    gemReward: 16,
    questions: [
      { id: 'q7_1', type: 'scenario', scenario: 'Trận bóng kết thúc, bạn hét: “Tao biết ngay là đội này thắng mà!”', options: ['Bạn tiên tri', 'Hindsight bias', 'Ăn may', 'Oai'], correctIndex: 1, explanation: 'Não tự vẽ lại quá khứ để thấy mình thông thái hơn.' },
      { id: 'q7_2', type: 'scenario', scenario: 'Thấy người khác thất bại, bạn bảo “tôi đã cảnh báo rồi” dù trước đó im lặng.', options: ['Bạn tốt', 'Hindsight bias', 'Họ dốt', 'Do duyên'], correctIndex: 1, explanation: 'Sửa ký ức để trông như mình đã biết trước.' },
      { id: 'q7_3', type: 'scenario', scenario: 'Sau vụ án, thám tử bảo “Manh mối rõ thế này mà không thấy”.', options: ['Đúng thế', 'Hindsight bias', 'Họ dốt', 'Sự thật'], correctIndex: 1, explanation: 'Khi đã biết kết quả, mọi thứ trông có vẻ logic hiển nhiên.' },
      { id: 'q7_4', type: 'scenario', scenario: 'Bạn đầu tư thua và tự trách “lẽ ra mình phải nhận ra bẫy này”.', options: ['Hối hận', 'Bẫy nhận thức muộn', 'Do bẫy khó', 'Cố lên'], correctIndex: 1, explanation: 'Kiến thức chỉ có sau khi sự kiện xảy ra.' },
      { id: 'q7_5', type: 'scenario', scenario: 'Sếp mắng: “Việc đơn giản thế này sao không làm được?”', options: ['Sếp thông minh', 'Sếp bị bẫy Hindsight', 'Sếp ác', 'Khó thật'], correctIndex: 1, explanation: 'Lời nguyền của kiến thức – khi biết rồi thì thấy dễ.' },
      { id: 'q7_6', type: 'scenario', scenario: 'Sếp làm xong thấy dễ, quên lúc đầu sếp cũng tịt.', options: ['Hindsight bias', 'Sếp đỉnh', 'Bình thường', 'Do may'], correctIndex: 0, explanation: 'Kết quả làm mờ nỗ lực tư duy ban đầu.' },
      { id: 'q7_7', type: 'scenario', scenario: 'Lịch sử luôn được viết “Sự sụp đổ là tất yếu”.', options: ['Đúng thế', 'Người viết sử bị Hindsight bias', 'Sự thật', 'Do rảnh'], correctIndex: 1, explanation: 'Gán sự logic cho những biến cố ngẫu nhiên.' },
      { id: 'q7_8', type: 'scenario', scenario: 'Thám tử nhìn một thất bại như thế nào?', options: ['Biết thế thì…', 'Phân tích dữ liệu lúc đó thay vì lúc này', 'Đi ngủ', 'Bỏ nghề'], correctIndex: 1, explanation: 'Phải đặt mình vào bối cảnh chưa biết kết quả.' }
    ]
  },
  {
    id: 'q8',
    title: 'Tay lái siêu hạng – Ảo tưởng vượt trội',
    regionId: 'r1',
    requiredLevel: 8,
    xpReward: 200,
    gemReward: 20,
    questions: [
      { id: 'q8_1', type: 'scenario', scenario: 'Bạn tin mình lái xe giỏi hơn 90% người trên đường.', options: ['Đúng thế', 'Better–than–average effect', 'Bạn là racer', 'Mọi người dở'], correctIndex: 1, explanation: '90% người khác cũng nghĩ y hệt bạn.' },
      { id: 'q8_2', type: 'scenario', scenario: '80% sinh viên nghĩ mình thông minh hơn mức trung bình của lớp.', options: ['Lớp toàn thiên tài', 'Ảo tưởng vượt trội', 'Sự thật', 'Do thầy'], correctIndex: 1, explanation: 'Nghịch lý thống kê do tự tin thái quá.' },
      { id: 'q8_3', type: 'scenario', scenario: 'Bạn tin mình “miễn nhiễm” với các bẫy tâm lý hơn người khác.', options: ['Bạn quá tỉnh', 'Blind spot bias', 'Đúng thế', 'Học xong là thế'], correctIndex: 1, explanation: 'Nghĩ mình không bị bẫy cũng là một cái bẫy.' },
      { id: 'q8_4', type: 'scenario', scenario: 'Hầu hết cặp đôi nghĩ tình yêu mình bền vững hơn mức trung bình.', options: ['Tình yêu đích thực', 'Ảo tưởng vượt trội', 'Do họ yêu nhau', 'Sự thật'], correctIndex: 1, explanation: 'Cơ chế bảo vệ hạnh phúc cá nhân.' },
      { id: 'q8_5', type: 'scenario', scenario: 'Bạn nghĩ mình có gu thẩm mỹ cao hơn bạn bè.', options: ['Đỉnh', 'Better–than–average effect', 'Bạn bè gu kém', 'Tùy người'], correctIndex: 1, explanation: 'Cái tôi luôn muốn mình nổi bật.' },
      { id: 'q8_6', type: 'scenario', scenario: 'Làm việc nhóm, bạn thề là mình làm nhiều việc nhất.', options: ['Đúng thế', 'Ảo tưởng đóng góp', 'Bạn bè lười', 'Tình cờ'], correctIndex: 1, explanation: 'Luôn phóng đại nỗ lực của chính mình.' },
      { id: 'q8_7', type: 'scenario', scenario: '90% người tự nhận mình tử tế hơn người thường.', options: ['Thế giới tươi đẹp', 'Nghịch lý đạo đức tự thân', 'Họ tử tế thật', 'Ảo giác'], correctIndex: 1, explanation: 'Cái nhìn phi thực tế về bản thân.' },
      { id: 'q8_8', type: 'scenario', scenario: 'Thám tử làm gì để thoát khỏi ảo tưởng vượt trội?', options: ['Tự tin lên', 'Kiểm chứng bằng con số khách quan', 'Nghe sếp', 'Nghỉ ngơi'], correctIndex: 1, explanation: 'Con số không nói dối, nhưng não thì có.' }
    ]
  },
